...
#df = pd.read_csv('M:\Master Thesis\TestData\matlabWorkspace\BPFCombline\\i1.txt',skiprows=range(0,3),
                 #names= headers, sep= '\t', float_precision=None)
df = pd.read_csv('M:\Master Thesis\TestData\matlabWorkspace\DielectricFilterTD\\reflected.csv',skiprows=range(0,1800),
                 names= headers, sep= '\t', float_precision=None, nrows = 600)
df.head(5)
print(len(df))
print(df[:5])
